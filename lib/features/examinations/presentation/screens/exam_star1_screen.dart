...
class ExamStar1Screen extends ConsumerStatefulWidget {
  final String examinationId;
  final String? from;

  const ExamStar1Screen({
    super.key,
  ...
  @override
  ConsumerState<ExamStar1Screen> createState() => _ExamStar1ScreenState();
}

class _ExamStar1ScreenState extends ConsumerState<ExamStar1Screen> {
  ...
  static const List<_StarPairRow> _rows = [
    _StarPairRow(leftLabel: 'P', leftKey: 'p1', rightKey: 'c1', rightLabel: 'C'),
    _StarPairRow(leftLabel: 'GI', leftKey: 'gi1', rightKey: 'ig1', rightLabel: 'IG'),
    _StarPairRow(leftLabel: 'P', leftKey: 'p2', rightKey: 'f1', rightLabel: 'F'),
    _StarPairRow(leftLabel: 'GI', leftKey: 'gi2', rightKey: 'vb1', rightLabel: 'VB'),
    _StarPairRow(leftLabel: 'P', leftKey: 'p3', rightKey: 'r1', rightLabel: 'R'),
    _StarPairRow(leftLabel: 'GI', leftKey: 'gi3', rightKey: 'v1', rightLabel: 'V'),
    _StarPairRow(leftLabel: 'P', leftKey: 'p4', rightKey: 'rp1', rightLabel: 'RP'),
    _StarPairRow(leftLabel: 'GI', leftKey: 'gi4', rightKey: 'e1', rightLabel: 'E'),
    _StarPairRow(leftLabel: 'RP', leftKey: 'rp2', rightKey: 'c2', rightLabel: 'C'),
    _StarPairRow(leftLabel: 'E', leftKey: 'e2', rightKey: 'ig2', rightLabel: 'IG'),
  ];
  ...
  Future<void> _saveAndNext() async {
    ...
    await ref.read(saveStar1ControllerProvider.notifier).save(model);
    ...
    if (mounted) {
      final from = widget.from == 'result' ? '?from=result' : '';
      context.push('/examinations/${widget.examinationId}/star1-part2$from');
    }
  }
  ...
  ExamStar1Model _buildModel() {
    return ExamStar1Model(
      ...
      r1: _values['r1']!, r2: _values['r2']!, r3: _values['r3']!, r4: _values['r4']!,
      ...
      v1: _values['v1']!, v2: _values['v2']!, v3: _values['v3']!, v4: _values['v4']!,
      c1: _values['c1']!, c2: _values['c2']!, c3: _values['c3']!, c4: _values['c4']!,
      f1: _values['f1']!, f2: _values['f2']!, f3: _values['f3']!, f4: _values['f4']!,
      ig1: _values['ig1']!, ig2: _values['ig2']!, ig3: _values['ig3']!, ig4: _values['ig4']!,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Сравнение пульсов по основной звезде — часть 1'),
      ...
      body: existingAsync.when(
        data: (data) {
          ...
          return ListView(
            ...
            children: [
              const Text(
                'Сравнение пульсов по основной звезде',
