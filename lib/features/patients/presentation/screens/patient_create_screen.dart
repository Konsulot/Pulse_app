...
class PatientCreateScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PatientCreateScreen> createState() => _PatientCreateScreenState();
}
...
class _PatientCreateScreenState extends ConsumerState<PatientCreateScreen> {
  ...
  Future<void> _submit() async {
    ...
    await ref.read(createPatientControllerProvider.notifier).createPatient(
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(createPatientControllerProvider);
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: AppButton(title: 'Сохранить', isLoading: state.isLoading, onPressed: _submit),
              ),
            ],
          ),
        ),
